...
const routes = [
    ...
    {
        path: 'usuarios',
        loadChildren: () => __webpack_require__.e(/*! import() | userslist-userslist-module */ "userslist-userslist-module").then(__webpack_require__.bind(null, /*! ./userslist/userslist.module */ "./src/app/userslist/userslist.module.ts")).then(m => m.UserslistPageModule)
    },
    {
        path: 'profile/:id',
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ionic-angular\src\main.ts */"./src/main.ts");
